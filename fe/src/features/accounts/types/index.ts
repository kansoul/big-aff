...
/** Values accepted by the BE AdsType enum (facebook | google | tiktok) */
export type AdsTypeFilterValue = 'facebook' | 'google' | 'tiktok'
...
export const accountCreateSchema = z.object({
  ads_type: z.enum(['facebook', 'google', 'tiktok'], {
