...
import { AdxAccountDialog, AdxDeleteDialog } from '@/features/adx/components'
import {
            ...
            {loading ? (
              ...
              items.map((account) => (
                <TableRow key={account.id}>
                  <TableCell><MonoText value={account.account_id} /></TableCell>
                  <TableCell>{account.account_name ?? '-'}</TableCell>
                  <TableCell><StatusPill value={account.source} /></TableCell>
                  <TableCell><StatusPill value={account.status} /></TableCell>
