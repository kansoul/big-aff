        ...
        children: [
          {
            ...
            children: [
              ...
              },
              {
                ...
                lazy: async () => {
                  const { SettingsUsersPage } =
                    await import('@/features/users/pages/SettingsUsersPage')
                  return {
              ...
              },
              {
                ...
                lazy: async () => {
                  const { MainTeamsPage } =
                    await import('@/features/main-teams/pages/MainTeamsPage')
                  return {
              ...
              },
              {
                ...
                lazy: async () => {
                  const { AdsReportPage } =
                    await import('@/features/ads-report/pages/AdsReportPage')
                  return {
              ...
              },
              {
                ...
                lazy: async () => {
                  const { TeamReportPage } =
                    await import('@/features/team-report/pages/TeamReportPage')
                  return {
              ...
              },
              {
                ...
                lazy: async () => {
                  ...
                  return {
                    Component: withPermission(
                      CampaignReportPage,
                      PermissionSlugs.CampaignReportsView,
                    ),
                  }
                },
              ...
              },
              {
                ...
                lazy: async () => {
                  ...
                  return {
                    Component: withPermission(
                      RevenueReportPage,
                      PermissionSlugs.RevenueReportsView,
                    ),
                  }
                },
