...
class FetchTikTokAdsDeliveryEntitiesCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'reports:fetch-ads-adsets-by-tiktok
     ...
     * @var string
     */
    protected $description = 'Fetch TikTok ad groups and ads from campaigns that have spending today';
    ...
    private function getAccountIds(Carbon $date): Collection
    {
        return Campaign::query()
            ...
            ->where('campaigns.ads_type', AdsType::TIKTOK->value)
            ->when(
