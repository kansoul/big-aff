    ...
    public function getCampaignsFilteredByInsights(string $accountId, array $insights): ?array
    {
        ...
        foreach ($campaignsCursor as $campaign) {
            $filteredCampaigns[] = [
                ...
                'start_time' => $campaign->start_time ? Carbon::parse($campaign->start_time) : null,
                'stop_time' => $campaign->stop_time ? Carbon::parse($campaign->stop_time) : null,
                'created_time' => $campaign->created_time ? Carbon::parse($campaign->created_time) : null,
                'updated_time' => $campaign->updated_time ? Carbon::parse($campaign->updated_time) : null,
                'created_at' => now(),
                'updated_at' => now(),
            ];
        }
